...
Token::Token(Type type, const std::string &text, std::unique_ptr<Value> value)
    : type_(type), text_(text), value_(std::move(value)) {
}
...
std::ostream &operator<<(std::ostream &os, const my_cpp::Token &token) {
    ...
    case my_cpp::Token::Type::T_SLASH:
        os << "TOKEN /";
        break;
    case my_cpp::Token::Type::T_EQ:
        os << "TOKEN ==";
        break;
    case my_cpp::Token::Type::T_NE:
        os << "TOKEN !=";
        break;
    case my_cpp::Token::Type::T_LT:
        os << "TOKEN <";
        break;
    case my_cpp::Token::Type::T_GT:
        os << "TOKEN >";
        break;
    case my_cpp::Token::Type::T_LE:
        os << "TOKEN <=";
        break;
    case my_cpp::Token::Type::T_GE:
        os << "TOKEN >=";
        break;
