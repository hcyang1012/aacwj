...
size_t CodeGeneratorX86::codegen_eq(size_t left_reg, size_t right_reg) {
    return codegen_compare(left_reg, right_reg, "sete");
}
size_t CodeGeneratorX86::codegen_ne(size_t left_reg, size_t right_reg) {
    return codegen_compare(left_reg, right_reg, "setne");
}
size_t CodeGeneratorX86::codegen_lt(size_t left_reg, size_t right_reg) {
    return codegen_compare(left_reg, right_reg, "setl");
}
size_t CodeGeneratorX86::codegen_gt(size_t left_reg, size_t right_reg) {
    return codegen_compare(left_reg, right_reg, "setg");
}
size_t CodeGeneratorX86::codegen_le(size_t left_reg, size_t right_reg) {
    return codegen_compare(left_reg, right_reg, "setle");
}
size_t CodeGeneratorX86::codegen_ge(size_t left_reg, size_t right_reg) {
    return codegen_compare(left_reg, right_reg, "setge");
}
