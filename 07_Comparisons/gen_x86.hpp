...
private:
    ...
    size_t codegen_eq(size_t left_reg, size_t right_reg) override final;
    size_t codegen_ne(size_t left_reg, size_t right_reg) override final;
    size_t codegen_lt(size_t left_reg, size_t right_reg) override final;
    size_t codegen_gt(size_t left_reg, size_t right_reg) override final;
    size_t codegen_le(size_t left_reg, size_t right_reg) override final;
    size_t codegen_ge(size_t left_reg, size_t right_reg) override final;
